...
export default function PortfolioPage() {
  ...
  const jsonLd = {
    ...
    "@type": "ItemList",
    "name": lang === "id" ? "Portfolio Indevtech" : "Indevtech Portfolio",
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main> {/* SEO: Menggunakan tag main untuk konten utama */}

        {/* Hero Section */}
        <section className="pt-40 pb-20 px-6 border-b border-border/50">
          <div className="max-w-7xl mx-auto">
            <header className="space-y-6 max-w-4xl">
              <span className="text-primary text-xs uppercase tracking-[0.3em] font-black block">{t.hero.tag}</span>
        ...
        {/* Category Filter */}
        <nav aria-label="Project categories" className="py-12 px-6 sticky top-20 bg-background/95 backdrop-blur-md border-b border-border/50 z-40 overflow-x-auto scrollbar-hide">
          <div className="max-w-7xl mx-auto">
      ...
      <footer className="py-16 px-6 border-t border-border/50 text-center text-muted-foreground text-sm">
        <p>&copy; 2025 Indev Tech Solutions. All Rights Reserved. - {lang === "id" ? "Solusi Pengembangan Software" : "Software Development Solutions"}</p>
      </footer>
    </div>
  )
}